...
<header class="sticky top-0 z-30 flex h-16 items-center gap-4 border-b bg-white px-4 shadow-sm lg:px-6">
    ...
    <!-- Título de la página -->
    <div class="flex-1">
        <h1 class="text-xl font-semibold text-gray-800" id="page-title"><?php echo isset($pageTitle) ? htmlspecialchars($pageTitle) : 'Dashboard'; ?></h1>
    </div>
    ...
    <div class="flex items-center space-x-4">
        ...
        <div class="flex items-center space-x-3">
            <div class="hidden md:block text-right">
                <p class="text-sm font-medium text-gray-800"><?php echo htmlspecialchars($user['nombre_completo'] ?? 'Admin'); ?></p>
