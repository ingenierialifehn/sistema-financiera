...
<div class="mb-6">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600">Gestiona los colaboradores (trabajadores) del sistema</p>
        </div>
        <button id="btnNuevoColaborador" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg transition flex items-center space-x-2">
...
<div id="colaboradorModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div class="sticky top-0 bg-white border-b px-6 py-4 flex justify-between items-center">
            <h3 class="text-xl font-bold text-gray-800" id="modalTitle">Nuevo Colaborador</h3>
            <button id="btnCerrarModal" class="text-gray-400 hover:text-gray-600">
                <i class="fas fa-times text-xl"></i>
            </button>
        </div>
        
        <form id="colaboradorForm" class="p-6">
