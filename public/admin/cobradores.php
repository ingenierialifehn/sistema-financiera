...
<div class="mb-6">
    <div class="flex justify-between items-center">
        ...
        <button id="btnNuevoCobrador" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg transition flex items-center space-x-2">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Cobros Hoy</th>
...
<div id="asignarClientesModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white rounded-lg shadow-xl max-w-3xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div class="p-6">
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <button type="button" id="btnCancelarAsignar" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition">
                    Cancelar
                </button>
                <button type="button" id="btnGuardarAsignacion" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition">
