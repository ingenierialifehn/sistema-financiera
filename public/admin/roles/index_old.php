                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            ...
                                            $moduleCategories = [
                                                'Administración' => [
                                                    ...
                                                    'seguridad' => 'Seguridad (Roles y Permisos)',
                                                ],
                                                'Operaciones Diarias' => [
                                                    'operaciones' => 'Operaciones de Agencia',
                                                    'caja' => 'Control de Caja',
                                                    'boveda' => 'Bóveda (Jalar Fondos)',
                                                ],
                                                'Gestión de Clientes y Créditos' => [
                                                    ...
                                                    'cobrador' => 'Cobrador (Ruta de Cobro)',
                                                ],
                                            ...
                                            // Flatten para mantener compatibilidad con código existente
                                            $modules = [];
                                            foreach ($moduleCategories as $category => $mods) {
                                            ...
                                            foreach ($moduleCategories as $category => $categoryModules): ?>
                                                ...
                                                <tr class="bg-gray-100">
                                                    <td colspan="4"
                                                        class="px-4 py-2 text-xs font-bold text-gray-700 uppercase">
                                                        <i class="fas fa-folder mr-2"></i><?php echo $category; ?>
                                                    </td>
                                                </tr>
                                                <?php foreach ($categoryModules as $key => $label): ?>
                                                    <tr class="hover:bg-gray-50">
                                                        <td class="px-4 py-2 text-sm font-medium text-gray-900 pl-8">
                                                            <i
                                                                class="fas fa-angle-right mr-2 text-gray-400"></i><?php echo $label; ?>
                                                        </td>
