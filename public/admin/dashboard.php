        ...
        <div class="bg-white rounded-lg shadow p-6 mb-8">
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex space-x-2">
                    <button onclick="loadChart(7)" class="px-3 py-1 text-sm bg-gray-200 hover:bg-gray-300 rounded">7 días</button>
                    <button onclick="loadChart(30)" class="px-3 py-1 text-sm bg-indigo-600 text-white hover:bg-indigo-700 rounded">30 días</button>
                    <button onclick="loadChart(90)" class="px-3 py-1 text-sm bg-gray-200 hover:bg-gray-300 rounded">90 días</button>
                </div>
            </div>
